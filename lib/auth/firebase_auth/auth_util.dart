...
DocumentReference? get currentUserReference =>
    loggedIn ? ProdutosRecord.collection.doc(currentUser!.uid) : null;

ProdutosRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : ProdutosRecord.getDocument(ProdutosRecord.collection.doc(uid))
              .handleError((_) {}),
    )

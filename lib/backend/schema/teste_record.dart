...
class TesteRecordDocumentEquality implements Equality<TesteRecord> {
  const TesteRecordDocumentEquality();

  @override
  bool equals(TesteRecord? e1, TesteRecord? e2) {
  ...
  @override
  int hash(TesteRecord? e) => const ListEquality().hash([
        e?.name,
        e?.description,
        e?.specifications,
        e?.price,
  ...
  @override
  bool isValidKey(Object? o) => o is TesteRecord;
}
